// filepath: /Users/flashcode/Desktop/REKAP DESKTOP/project-siska/resources/js/pages/Admin/RiwayatPembelian/Show.tsx
...
export default function Show({ transaction }: Props) {
    const handleBack = () => {
        router.visit(route('admin.riwayat-pembelian.index'));
    };
    ...
    const handleDownload = () => {
        window.open(route('pos.download', transaction.id), '_blank');
    };
                ...
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-muted-foreground">Invoice: {transaction.nomor_invoice}</p>
                        </div>
                    </div>
                    ...
                    <div className="space-y-6">
                        ...
                        <Card>
                            ...
                            <CardContent className="space-y-3">
                                ...
                                <div>
                                    <label className="text-sm font-medium text-muted-foreground">Email</label>
                                    <p className="text-sm">{transaction.kasir.email}</p>
                                </div>
                            </CardContent>
                        </Card>
